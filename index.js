...
${color.bold('Routes:')} Spectre audits YOUR routes. Provide a spectre.routes.ts
  (see ${color.dim('routes.example.ts')}), a spectre.config.ts, a package.json
  "spectre": { "routes" } field, or set ${color.dim('SPECTRE_ROUTES')}.
